...
create function DatosDelProducto()
 ...
 begin
	insert into @TablaARetornar
		...
		Production.Product.StandardCost, Production.Product.ListPrice,Production.Product.ListPrice,
...
exec conseguirInfoProductoEspecifico @id = 2
...
exec conseguirTransacciones @id=2
----------------------------------------------------------------------------------------------------------------------------------Modelo de Clientes
...
drop procedure conseguirClientes
...
exec conseguirVentas @nombreEspecifico = 'ach';
